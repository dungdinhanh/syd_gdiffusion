...
from guided_diffusion_hfai.image_datasets import load_dataset_CIFAR10
...
from guided_diffusion_hfai.script_util_32 import create_model_and_diffusion_cifar10
...
def main(local_rank):
    ...
    data = load_dataset_CIFAR10(
        train=True, batch_size=args.batch_size, class_cond=args.class_cond, data_folder=None
    )
