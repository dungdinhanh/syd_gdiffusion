...
from guided_diffusion_hfai.script_util_mlt_analyse import create_model_and_diffusion_ddiv_analyse # diffusion - classification conflict + classification - diversity conflict
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_ddiv_analyse(
