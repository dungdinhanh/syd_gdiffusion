...
from guided_diffusion_hfai.script_util_classifier_free import (
    NUM_CLASSES,
    model_and_diffusion_defaults,
    classifier_defaults,
    create_model_and_diffusion_classifier_free_mlt5,
    create_classifier,
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_classifier_free_mlt5(
