...
PCGrad 1 way only project from diffusion to diversity/ do not update from diversity to diffusion
"""
...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt_ddiv1wdiv
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_ddiv1wdiv(
