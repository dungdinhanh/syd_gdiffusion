...
PCGRad only for diffusion and diversity pair/ only update diffusion, not update diversity
exclude diffusion scheduling before applying PCGrad
apply adaptive basing on magnitude
"""
...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt_1wdiff_excsch_adaptivem
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_1wdiff_excsch_adaptivem(
