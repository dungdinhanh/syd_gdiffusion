...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt_ddiv_adaptive
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_ddiv_adaptive(
