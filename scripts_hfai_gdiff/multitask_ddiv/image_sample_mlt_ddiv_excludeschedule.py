...
PCGRad only for diffusion and diversity pair
...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt_ddiv_excsch
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_ddiv_excsch(
