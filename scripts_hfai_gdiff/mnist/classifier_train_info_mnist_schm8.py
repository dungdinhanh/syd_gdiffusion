...
Use InfoQ fixed for transfering clean to clean image + Unet classifer for learning disentangled + KD cat transfer + Argmax cat dis + no con
"""
# import hfai_env
...
def main(local_rank):
    ...
    output_channels = cat_dim * num_cat
