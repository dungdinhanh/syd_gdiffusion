...
PCGrad on all batches of images
"""
...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt(
