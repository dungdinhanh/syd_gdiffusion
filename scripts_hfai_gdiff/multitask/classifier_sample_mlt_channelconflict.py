...
PCGrad on each channel in image/each image in batch
"""
...
from guided_diffusion_hfai.script_util_mlt import create_model_and_diffusion_mlt_channelconflict
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_channelconflict(
