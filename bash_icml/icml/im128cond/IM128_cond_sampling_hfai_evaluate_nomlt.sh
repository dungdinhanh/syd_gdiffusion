...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling_icml/IMN128/conditional_nomlt/scale${scale}p0/reference/samples_50000x128x128x3.npz"
#echo ${cmd}
#eval ${cmd}
done
...
do
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling_icml/IMN128/conditional_nomlt/scale0p${scale}/reference/samples_50000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
done
