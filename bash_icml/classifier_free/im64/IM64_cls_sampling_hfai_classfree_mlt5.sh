...
SAMPLE_FLAGS="--batch_size 132 --num_samples 50000 --timestep_respacing 250"
...
#scales=( "0.01" "0.03" "0.005" "0.007")
scales=( "0.0000001" "0.000001" "0.00001" "0.0001" )
...
--model_path runs/IM64/IM64_diffusion_training_unconditional/models/ema_0.9999_540000_final.pt  $SAMPLE_FLAGS \
 --logdir runs/sampling_icml_classifier_free/IMN64/mlt_delta/scale${scale}/ "
echo ${cmd}
eval ${cmd}
done

#cmd="python scripts_hfai_gdiff/classifier_free/classifier_free_sample_mlt.py $MODEL_FLAGS --cond_model_scale 0.2  \
#--cond_model_path  models/64x64_diffusion.pt  \
#--model_path ../output/diff_models/IM64/IM64_diffusion_training_unconditional/models/ema_0.9999_540000_final.pt  $SAMPLE_FLAGS \
# --logdir runs/test_classifier_free/ "
#echo ${cmd}
#eval ${cmd}
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling_icml_classifier_free/IMN64/mlt_delta/scale${scale}/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done
