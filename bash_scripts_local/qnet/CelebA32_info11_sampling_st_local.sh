...
sample_model_path="../output/runs/celeba32info/celeba32_info11"

cmd="python scripts_hfai_local/classifier_sample_infoq_celeba_disengtangle.py --logdir ${sample_model_path}/ref/sampling_s0 ${MODEL_FLAGS} \
...
cmd="python scripts_hfai_local/classifier_sample_infoq_celeba_disengtangle.py --logdir ${sample_model_path}/ref/sampling_s5 ${MODEL_FLAGS} \
--classifier_scale 5.0 --classifier_attention_resolutions 16,8,4 --classifier_path ${sample_model_path}/models/model199999.pt \
 --classifier_depth 3 --model_path ../output/runs/celeba32/celeba32_diff_dbg/models/ema_0.9999_300000_final.pt ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}

cmd="python scripts_hfai_local/classifier_sample_infoq_celeba_disengtangle.py --logdir ${sample_model_path}/ref/sampling_s3 ${MODEL_FLAGS} \
--classifier_scale 3.0 --classifier_attention_resolutions 16,8,4 --classifier_path ${sample_model_path}/models/model199999.pt \
 --classifier_depth 3 --model_path ../output/runs/celeba32/celeba32_diff_dbg/models/ema_0.9999_300000_final.pt ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}

cmd="python scripts_hfai_local/classifier_sample_infoq_celeba_disengtangle.py --logdir ${sample_model_path}/ref/sampling_s7 ${MODEL_FLAGS} \
--classifier_scale 7.0 --classifier_attention_resolutions 16,8,4 --classifier_path ${sample_model_path}/models/model199999.pt \
 --classifier_depth 3 --model_path ../output/runs/celeba32/celeba32_diff_dbg/models/ema_0.9999_300000_final.pt ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}

cmd="python scripts_hfai_local/classifier_sample_infoq_celeba_disengtangle.py --logdir ${sample_model_path}/ref/sampling_s10 ${MODEL_FLAGS} \
