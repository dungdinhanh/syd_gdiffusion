...
cmd="python scripts_hfai_local/info/classifier_localtrain_info_mnist_schm14.py --data_dir path/to/imagenet \
--logdir ../outputhfai/local_analyse/twostages/info_schm14/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}