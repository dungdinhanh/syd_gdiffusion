...
cmd="${cd_cmd} python scripts_hfai_local/classifier_localtrain_info_mnist_schm11.py --data_dir path/to/imagenet \
...
--model_path ${mpath} \
--logdir ${opath}/${name}20/ --classifier_scale 20.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
