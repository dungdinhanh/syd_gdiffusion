...
cmd="${cd_command} python scripts_hfai_local/classifier_localtrain_info_mnist_schm4.py --data_dir path/to/imagenet --logdir ../outputhfai/local_runs_info/mnist_info4_classifier_training/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
#echo ${cmd}
#eval ${cmd}
...
cpath="../outputhfai/local_runs_info/mnist_info4_classifier_training/models/model199999.pt"
mpath="../outputhfai/runs/mnist_diffusion_training_1node/models/model200000.pt"
opath="../outputhfai/local_test"
namee="mnist_infosc4_manipulation_sampling_1node"


cmd="${cd_command} python scripts_hfai_local/classifier_sample_manipulation_local.py --classifier_path ${cpath} \
--model_path ${mpath} \
