...
#echo ${cmd}
#eval ${cmd}
cd_command="CUDA_VISIBLE_DEVICES=0"
...
cpath="../outputhfai/local_analyse/mnist_tuneh/$1/models/model149999.pt"
mpath="../outputhfai/runs/mnist_diffusion_training_1node/models/model200000.pt"
opath="../outputhfai/local_analyse/mnist_tuneh/$1_ref/"
name="sampling_s"

cmd="${cd_command} python scripts_hfai_local/classifier_sample_local.py --classifier_path ${cpath} \
--model_path ${mpath} \
--logdir ${opath}/${name}1/ --classifier_scale 1.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
...
cmd="${cd_command} python scripts_hfai_local/classifier_sample_local.py --classifier_path ${cpath} \
--model_path ${mpath} \
--logdir ${opath}/${name}2/ --classifier_scale 2.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
...
cmd="${cd_command} python scripts_hfai_local/classifier_sample_local.py --classifier_path ${cpath} \
--model_path ${mpath} \
--logdir ${opath}/${name}3/ --classifier_scale 3.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
...
cmd="${cd_command} python scripts_hfai_local/classifier_sample_local.py --classifier_path ${cpath} \
--model_path ${mpath} \
--logdir ${opath}/${name}4/ --classifier_scale 4.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
