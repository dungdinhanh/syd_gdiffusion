...
SAMPLE_FLAGS="--batch_size 2048 --num_samples 1000 --timestep_respacing 250"
...
cmd="${cd_command} python scripts_hfai_local/classifier_tsne_local.py --classifier_path ${cpath} \
