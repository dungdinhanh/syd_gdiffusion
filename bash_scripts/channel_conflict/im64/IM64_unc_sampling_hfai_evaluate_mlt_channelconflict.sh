...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling2/IMN64/unconditional_mlt2_chconf/scale${scale}p0/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling2/IMN64/unconditional_mlt2_chconf/scale0p5/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
