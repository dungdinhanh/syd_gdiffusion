...
cmd="python scripts_hfai_gdiff/multitask/classifier_sample_mlt.py $MODEL_FLAGS --classifier_scale 0.5  \
--classifier_path models/64x64_classifier.pt --model_path models/64x64_diffusion.pt $SAMPLE_FLAGS \
 --logdir runs/sampling/IMN64/conditional_mlt/scale0p5/ --classifier_depth 4"
#echo ${cmd}
#eval ${cmd}
