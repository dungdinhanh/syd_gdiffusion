...
do
cmd="python scripts_hfai_gdiff/multitask/classifier_sample_mlt2.py $MODEL_FLAGS --classifier_scale 0.${pscale}  \
--classifier_path models/64x64_classifier.pt \
 ...
 $SAMPLE_FLAGS --logdir runs/sampling2/IMN64/unconditional_mlt2/scale0p${pscale}/ --classifier_depth 4"
echo ${cmd}
eval ${cmd}
done

cmd="python scripts_hfai_gdiff/multitask/classifier_sample_mlt2.py $MODEL_FLAGS --classifier_scale 1.0  \
--classifier_path models/64x64_classifier.pt \
 --model_path runs/IM64/IM64_diffusion_training_unconditional/models/ema_0.9999_540000_final.pt \
 $SAMPLE_FLAGS --logdir runs/sampling2/IMN64/unconditional_mlt2/scale1p0/ --classifier_depth 4"
echo ${cmd}
eval ${cmd}