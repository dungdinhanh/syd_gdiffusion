...
cmd="python scripts_hfai_gdiff/classifier_sample.py --logdir runs/classifier_info_st_pretrained/ ${MODEL_FLAGS} \
--classifier_scale 1.0 --classifier_path runs/classifier_training_info_4nodes/models/model299999.pt \
