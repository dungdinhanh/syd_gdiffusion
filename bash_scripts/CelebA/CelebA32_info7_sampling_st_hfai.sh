...
sample_model_path="runs/celeba32info/celeba32_info7"

cmd="python scripts_hfai_gdiff/classifier_sample_infoq.py --logdir ${sample_model_path}/ref/sampling_s0 ${MODEL_FLAGS} \
--classifier_scale 0.0 --classifier_attention_resolutions 16,8,4 --classifier_path ${sample_model_path}/models/model199999.pt \
 --classifier_depth 3 --model_path runs/celeba32/celeba32_diff_dbg/models/ema_0.9999_300000_final.pt ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
