...
cmd="python scripts_hfai_gdiff/celeba32/classifier_train_info_celeba_schm9.py --data_dir path/to/imagenet \
    --logdir runs/celeba32info/celeba32_info9/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}