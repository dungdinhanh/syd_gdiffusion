...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling/IMN128/conditional_mlt/scale${scale}p0/reference/samples_10000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
done

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling/IMN128/conditional_mlt/scale0p5/reference/samples_10000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
