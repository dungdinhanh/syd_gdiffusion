...
--model_path models/128x128_diffusion.pt $SAMPLE_FLAGS  --logdir runs/sampling/IMN128/conditional/scale${scale}p0/"
echo ${cmd}
eval ${cmd}
done
...
--model_path models/128x128_diffusion.pt $SAMPLE_FLAGS  --logdir runs/sampling/IMN128/conditional/scale0p5/"
echo ${cmd}
eval ${cmd}
