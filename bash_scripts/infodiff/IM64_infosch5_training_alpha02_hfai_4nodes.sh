...
cmd="python scripts_hfai_gdiff/mnist/classifier_train_info_schm5.py --data_dir path/to/imagenet \
--logdir runs/infodiff/cls_scm3_alph02/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}