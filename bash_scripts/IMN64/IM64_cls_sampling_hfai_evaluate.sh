...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling/IMN64/conditional/scale${scale}p0/reference/samples_10000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling/IMN64/conditional/scale0p5/reference/samples_10000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
