...
cmd="python scripts_hfai_gdiff/mnist/classifier_train_info_mnist_schm7.py --data_dir path/to/imagenet \
--logdir runs/mnist_info/info_schm7/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}