...
cmd="python scripts_hfai_gdiff/mnist/classifier_train_info_mnist_schm5.py --data_dir path/to/imagenet \
--logdir runs/mnist_info/info_schm5_h02/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}