...
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True \
 --classifier_use_scale_shift_norm True --alphae 0.15"
...
cmd="python scripts_hfai_gdiff/mnist/classifier_train_info_mnist_schm3.py --data_dir path/to/imagenet --logdir runs/mnist_tuneh/info_schm3_h015/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}