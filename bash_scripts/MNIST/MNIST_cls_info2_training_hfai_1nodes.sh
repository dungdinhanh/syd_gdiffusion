...
cmd="python scripts_hfai_gdiff/classifier_train_info_mnist_schm2.py --data_dir path/to/imagenet --logdir runs/mnist_infos2_classifier_training/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}