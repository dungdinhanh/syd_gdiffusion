...
cmd="python scripts_hfai_gdiff/classifier_train_info_mnist.py --data_dir path/to/imagenet --logdir runs/mnist_info_classifier_training/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}