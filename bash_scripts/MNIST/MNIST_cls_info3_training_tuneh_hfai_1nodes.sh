...
cmd="python scripts_hfai_gdiff/mnist/classifier_train_info_mnist_schm3.py --data_dir path/to/imagenet --logdir runs/mnist_tuneh/info_schm3_h01/ $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}