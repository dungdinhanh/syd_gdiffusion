...
cmd="python scripts_hfai_gdiff/classifier_sample.py --classifier_path runs/mnist_classifier_training/models/model149999.pt \
--model_path runs/mnist_diffusion_training_1node/models/model200000.pt \
--logdir runs/mnist_cls_sampling_1node_s5/ --classifier_scale 5.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
...
cmd="python scripts_hfai_gdiff/classifier_sample.py --classifier_path runs/mnist_classifier_training/models/model149999.pt \
--model_path runs/mnist_diffusion_training_1node/models/model200000.pt \
--logdir runs/mnist_cls_sampling_1node_s6/ --classifier_scale 6.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
...
cmd="python scripts_hfai_gdiff/classifier_sample.py --classifier_path runs/mnist_classifier_training/models/model149999.pt \
--model_path runs/mnist_diffusion_training_1node/models/model200000.pt \
--logdir runs/mnist_cls_sampling_1node_s7/ --classifier_scale 7.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}
...
cmd="python scripts_hfai_gdiff/classifier_sample.py --classifier_path runs/mnist_classifier_training/models/model149999.pt \
--model_path runs/mnist_diffusion_training_1node/models/model200000.pt \
--logdir runs/mnist_cls_sampling_1node_s9/ --classifier_scale 9.0 --classifier_attention_resolutions 14,7 --classifier_depth 1 \
--classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_scale_shift_norm True \
 $MODEL_FLAGS ${SAMPLE_FLAGS}"
echo ${cmd}
eval ${cmd}