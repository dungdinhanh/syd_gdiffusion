...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet256_labeled.npz \
 runs/sampling/IMN256/unconditional/scale1p0/reference/samples_50000x256x256x3.npz"
echo ${cmd}
eval ${cmd}

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet256_labeled.npz \
 runs/sampling/IMN256/unconditional/scale10p0/reference/samples_50000x256x256x3.npz"
echo ${cmd}
eval ${cmd}

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet256_labeled.npz \
 runs/sampling/IMN256/unconditional/scale0p0/reference/samples_50000x256x256x3.npz"
echo ${cmd}
eval ${cmd}
