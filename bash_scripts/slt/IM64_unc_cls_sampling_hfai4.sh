...
do
cmd="python scripts_hfai_gdiff/classifier_sample.py $MODEL_FLAGS --classifier_scale 0.${pscale}  \
--classifier_path models/64x64_classifier.pt \
 ...
 $SAMPLE_FLAGS --logdir runs/sampling2/IMN64/unconditional/scale0p${pscale}/ --classifier_depth 4"
#echo ${cmd}
#eval ${cmd}
done
...
--classifier_path models/64x64_classifier.pt \
 --model_path runs/IM64/IM64_diffusion_training_unconditional/models/ema_0.9999_540000_final.pt \
 $SAMPLE_FLAGS --logdir runs/sampling2/IMN64/unconditional/scale1p0/ --classifier_depth 4"
echo ${cmd}
eval ${cmd}