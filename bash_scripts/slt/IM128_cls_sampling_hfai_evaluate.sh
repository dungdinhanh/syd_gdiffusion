...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling2/IMN128/conditional/scale${scale}p0/reference/samples_50000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
done

cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling2/IMN128/conditional/scale0p5/reference/samples_50000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
