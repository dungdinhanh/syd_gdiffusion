...
def main():
    ...
    # parser.add_argument("save_log", help="log files")
    ...
    log_file = os.path.join(os.path.dirname(args.sample_batch), "score.csv")
    f = open(log_file, "w")
    ...
    print("FID:", fid_score)
    print("sFID:", sfid_score)
    prec, recall = evaluator.compute_prec_recall(ref_acts[0], sample_acts[0])
    print("Precision:", prec)
    print("Recall:", recall)
    f.write("IS, FID, sFID, Precision, Recall\n")
    f.write(f"{is_score}, {fid_score}, {sfid_score}, {prec}, {recall}\n")
    f.close()
