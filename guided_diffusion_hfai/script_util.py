...
def create_model_and_diffusion_det(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    diffusion = create_gaussian_diffusion_det(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
        noise_schedule=noise_schedule,
        use_kl=use_kl,
...
from guided_diffusion_hfai.gaussian_diffusion_deterministic import GaussianDiffusionDeterministic


def create_gaussian_diffusion_det(
    *,
    steps=1000,
    learn_sigma=False,
    sigma_small=False,
    ...
    return GaussianDiffusionDeterministic(
